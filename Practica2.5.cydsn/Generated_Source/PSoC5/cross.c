...
{
    uint8 staticBits = (cross_DR & (uint8)(~cross_MASK));
    cross_DR = staticBits | ((uint8)(value << cross_SHIFT) & cross_MASK);
}
...
{
	CyPins_SetPinDriveMode(cross_0, mode);
}
...
{
    return (cross_PS & cross_MASK) >> cross_SHIFT;
}
...
{
    return (cross_DR & cross_MASK) >> cross_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(cross_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & cross_0_INTR) != 0u) 
		{ 
			 cross_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (cross_INTSTAT & cross_MASK) >> cross_SHIFT;
    }

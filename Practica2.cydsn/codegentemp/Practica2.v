// ======================================================================
// Practica2.v generated from TopDesign.cysch
// 06/04/2018 at 19:16
...
module top ;
    ...
    assign Net_6 = Net_4 & Net_5;

	wire [0:0] tmpOE__A_Pin_net;
	wire [0:0] tmpIO_0__A_Pin_net;
	wire [0:0] tmpINTERRUPT_0__A_Pin_net;
	electrical [0:0] tmpSIOVREF__A_Pin_net;
	...
	cy_psoc3_pins_v1_10
		...
		A_Pin
		 (.oe(tmpOE__A_Pin_net),
		  .y({1'b0}),
		  .fb({Net_4}),
		  .io({tmpIO_0__A_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__A_Pin_net),
		  .interrupt({tmpINTERRUPT_0__A_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__A_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__B_Pin_net;
	wire [0:0] tmpIO_0__B_Pin_net;
	wire [0:0] tmpINTERRUPT_0__B_Pin_net;
	electrical [0:0] tmpSIOVREF__B_Pin_net;
	...
	cy_psoc3_pins_v1_10
		...
		B_Pin
		 (.oe(tmpOE__B_Pin_net),
		  .y({1'b0}),
		  .fb({Net_5}),
		  .io({tmpIO_0__B_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__B_Pin_net),
		  .interrupt({tmpINTERRUPT_0__B_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__C_Pin_net;
	wire [0:0] tmpFB_0__C_Pin_net;
	wire [0:0] tmpIO_0__C_Pin_net;
	wire [0:0] tmpINTERRUPT_0__C_Pin_net;
	electrical [0:0] tmpSIOVREF__C_Pin_net;
	...
	cy_psoc3_pins_v1_10
		...
		C_Pin
		 (.oe(tmpOE__C_Pin_net),
		  .y({Net_6}),
		  .fb({tmpFB_0__C_Pin_net[0:0]}),
		  .io({tmpIO_0__C_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__C_Pin_net),
		  .interrupt({tmpINTERRUPT_0__C_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__C_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

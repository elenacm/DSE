...
#define generadorOnda_SetSpeed       generadorOnda_VDAC8_SetSpeed
#define generadorOnda_SetRange       generadorOnda_VDAC8_SetRange
#define generadorOnda_SetValue       generadorOnda_VDAC8_SetValue
#define generadorOnda_DacTrim        generadorOnda_VDAC8_DacTrim
#define generadorOnda_SaveConfig     generadorOnda_VDAC8_SaveConfig
#define generadorOnda_RestoreConfig  generadorOnda_VDAC8_RestoreConfig

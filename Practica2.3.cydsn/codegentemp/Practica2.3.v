// ======================================================================
// Practica2.3.v generated from TopDesign.cysch
// 06/04/2018 at 19:37
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("cfc97c28-51bc-428a-b382-bb082e125ffe/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    EdgeDetect_v1_0 EdgeDetect (
        ...
        .det(Net_7),
        .clock(Net_3));
    defparam EdgeDetect.EdgeType = 1;

    assign Net_9 = (Net_30[7:0] == Net_29[7:0]);
    ...
    defparam Status_Reg.BusDisplay = 1;

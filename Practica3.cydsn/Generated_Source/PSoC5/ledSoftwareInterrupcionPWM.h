...
*/
     ...
     *  @{
     */
        #define ledSoftwareInterrupcionPWM_DM_ALG_HIZ         PIN_DM_ALG_HIZ
        #define ledSoftwareInterrupcionPWM_DM_DIG_HIZ         PIN_DM_DIG_HIZ
        #define ledSoftwareInterrupcionPWM_DM_RES_UP          PIN_DM_RES_UP
        #define ledSoftwareInterrupcionPWM_DM_RES_DWN         PIN_DM_RES_DWN
        #define ledSoftwareInterrupcionPWM_DM_OD_LO           PIN_DM_OD_LO
        #define ledSoftwareInterrupcionPWM_DM_OD_HI           PIN_DM_OD_HI
        #define ledSoftwareInterrupcionPWM_DM_STRONG          PIN_DM_STRONG
        #define ledSoftwareInterrupcionPWM_DM_RES_UPDWN       PIN_DM_RES_UPDWN
    /** @} driveMode */
/** @} group_constants */
...
*/
     ...
     *  @{
     */
        #define ledSoftwareInterrupcionPWM_INTR_NONE      (uint16)(0x0000u)
        #define ledSoftwareInterrupcionPWM_INTR_RISING    (uint16)(0x0001u)
        #define ledSoftwareInterrupcionPWM_INTR_FALLING   (uint16)(0x0002u)
        #define ledSoftwareInterrupcionPWM_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */
...
#endif /*  CY_PINS_ledSoftwareInterrupcionPWM_H */

// ======================================================================
// Practica3.v generated from TopDesign.cysch
// 06/05/2018 at 12:30
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f9479408-f4d7-40d2-b69f-e267d56f92b6/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module UART_v2_50_2 (
	...
	cy_clock_v1_0
		#(.id("a8f7de82-9e40-42de-80a2-4498dc0476c8/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("d9b8af70-3bd0-4d69-a66e-56856b5dfea1"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    PWM_v3_30_0 generadorPulsosPWM (
        .reset(Net_18),
        .clock(Net_34),
        .tc(Net_48),
        .pwm1(Net_49),
        ...
        .ph1(Net_58),
        .ph2(Net_59));
    defparam generadorPulsosPWM.Resolution = 8;

    assign Net_18 = 1'h0;

	wire [0:0] tmpOE__ledHardwarePWM_net;
	wire [0:0] tmpFB_0__ledHardwarePWM_net;
	wire [0:0] tmpIO_0__ledHardwarePWM_net;
	wire [0:0] tmpINTERRUPT_0__ledHardwarePWM_net;
	electrical [0:0] tmpSIOVREF__ledHardwarePWM_net;
	...
	cy_psoc3_pins_v1_10
		...
		ledHardwarePWM
		 (.oe(tmpOE__ledHardwarePWM_net),
		  .y({Net_56}),
		  .fb({tmpFB_0__ledHardwarePWM_net[0:0]}),
		  .io({tmpIO_0__ledHardwarePWM_net[0:0]}),
		  .siovref(tmpSIOVREF__ledHardwarePWM_net),
		  .interrupt({tmpINTERRUPT_0__ledHardwarePWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ledHardwarePWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("c308cde0-29f9-4d97-a9eb-49dabf4519c2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
